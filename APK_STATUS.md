...
- Source commit: `7c18ee92d84f829547648225e086bb3f14305835`
- Workflow run: https://github.com/snow663/BFID-mapping/actions/runs/30909450464
- Finished: 2026-08-04 12:35:34 UTC

## Build log tail
```text

> bfid-mapping@0.2.2 tauri
...
> bfid-mapping@0.2.2 build
> vite build

12:32:30 PM [vite-plugin-svelte] no Svelte config found at /home/runner/work/BFID-mapping/BFID-mapping - using default configuration.
...
[2mdist/[22m[2massets/[22m[36mindex-BLkCCW9N.js   [39m[1m[33m2,253.53 kB[39m[22m[2m │ gzip: 484.86 kB[22m[2m │ map: 3,782.68 kB[22m
[32m✓ built in 7.13s[39m
...
[1m[92m  Downloaded[0m regex-automata v0.4.17
[1m[92m   Compiling[0m regex-automata v0.4.17
...
[1m[92m   Compiling[0m bfid-mapping v0.2.2 (/home/runner/work/BFID-mapping/BFID-mapping/src-tauri)
[1m[92m    Finished[0m `dev` profile [unoptimized + debuginfo] target(s) in 31.01s
...
> tauri android android-studio-script --target aarch64
        ...
        Info connection; remote_addr=127.0.0.1:38260 conn_id=0
...
[1m[92m    Finished[0m `dev` profile [unoptimized + debuginfo] target(s) in 16.91s
